...
| Pariona Chacca, Angel Jose         | Angelitoso-opp   | **Responsabilidad:** desarrollo de 2.1 Competidores y 2.2 Entrevistas.<br><br>**Realizado:** investigación y elaboración del benchmark competitivo (*Competitive Analysis Landscape* y FODA de Agrotech, AgroVista del Valle y Phytech); formulación de estrategias y tácticas con enfoque móvil; diseño de entrevistas estructuradas para los 3 segmentos objetivo; registro audiovisual y resúmenes descriptivos de 7 entrevistas; y consolidación del análisis estadístico y síntesis cualitativa de los hallazgos de campo.<br><br>                                                                    | **Ramas utilizadas:**<br>`feature/av1-chapter-2-competitors-and-interviews` |
...
| <img src="assets/images/cap1/foto-angel.png" alt="Foto">                                                                              | **Apellidos y nombres:** Pariona Chacca, Angel Jose<br>**Código:** U202314734<br>**Carrera:** Ingeniería de Software         | Mi nombre es Angel Pariona, tengo 21 años y actualmente curso el quinto ciclo de Ingeniería de Software. Soy una persona disciplinada, proactiva y orientada al trabajo colaborativo. Cuento con conocimientos en C++, HTML, CSS y desarrollo de software. En NovaTech, aporto en la investigación y análisis de competidores, el diseño y ejecución de entrevistas a los segmentos objetivo y la fundamentación de requisitos para la solución móvil de TerraTech. |
...
| **Overview** | Solución móvil conectada a sensores IoT de bajo costo que permite monitorear y consultar información actualizada sobre la humedad y nutrientes del suelo desde smartphones, generando alertas preventivas y análisis adaptado a las condiciones del campo peruano. | Empresa que implementa tecnología agrícola mediante el uso de drones, sensores y asesoría técnica especializada presencial para optimizar la productividad de los cultivos. | Empresa de servicios agrícolas que utiliza análisis multiespectral e imágenes satelitales/aéreas para monitorear la salud vegetal y evaluar las condiciones del terreno. | Plataforma digital internacional de agricultura de precisión que integra sensores IoT e inteligencia artificial para optimizar el riego y el rendimiento de cultivos a gran escala. |
| **Ventaja competitiva y valor ofrecido** | Monitoreo periódico del suelo con información actualizada, alertas preventivas oportunas, funcionamiento offline en la aplicación móvil con sincronización posterior, interfaz simplificada para baja alfabetización digital y costos accesibles para pequeños y medianos agricultores. | Soluciones integrales de hardware de alta gama (drones) y acompañamiento técnico presencial especializado. | Alta precisión en el análisis científico de imágenes multiespectrales para la detección temprana de anomalías en grandes extensiones. | Algoritmos avanzados de IA para la automatización de decisiones de riego a nivel empresarial con soporte global. |
...
| **Falta de información periódica y accesible en campo en competidores basados en vuelos programados (AgroVista del Valle)** | Posicionamiento en monitoreo periódico del suelo con información actualizada directamente en el smartphone. | Evaluar una frecuencia de transmisión adecuada para las lecturas de humedad y nutrientes, de manera que la aplicación pueda presentar información actualizada sin comprometer innecesariamente el consumo energético y de datos, facilitando decisiones oportunas de riego y fertilización. |
...
| **Conectividad intermitente o nula en zonas agrícolas rurales** | Resiliencia de la solución móvil mediante arquitectura offline-first y conectividad IoT adaptada a campo. | Incorporar almacenamiento local en el dispositivo móvil (SQLite/Room) para consulta de datos sin conexión y sincronización en segundo plano al recuperar señal, complementado con sensores cuya estrategia de conectividad de largo alcance será evaluada técnicamente, considerando alternativas como LoRaWAN según los resultados de las pruebas de viabilidad. |
| **Falta de herramientas para que el agricultor demuestre la procedencia y cultivo de su cosecha a compradores** | Transparencia y trazabilidad compartible desde el dispositivo móvil. | Permitir al agricultor generar fichas de trazabilidad y códigos QR desde la aplicación móvil para compartirlos por medios digitales o imprimirlos, facilitando a clientes y proveedores la consulta de información registrada sobre la procedencia, el cultivo y el uso de recursos. |

## 2.2. Entrevistas

### 2.2.1. Diseño de entrevistas

Para recopilar requisitos reales del dominio y diseñar la experiencia móvil de **TerraTech**, se prepararon guías de entrevista semiestructuradas orientadas a los tres segmentos objetivo: **Agricultores**, **Proveedores de Insumos Agrícolas** y **Clientes Finales / Compradores**.
...
| **ENT-003** | Clientes Finales / Compradores | Anita Monago Cachay | 35 | Lima | 29/03/2026 | 23:58 - 30:32 | [Video](https://tinyurl.com/nhcd3sx8) <br> <img src="assets/images/cap2/entrevista-21.png" alt="Anita" width="100"> |
...
| **ENT-005** | Clientes Finales / Compradores | Anjali Amaro | 25 | Lima | 30/03/2026 | 36:35 - 43:45 | [Video](https://tinyurl.com/44zrjtsp) <br> <img src="assets/images/cap2/entrevista-31.png" alt="Anjali" width="100"> |
| **ENT-006** | Clientes Finales / Compradores | Luciana Aguilar | 17 | La Molina (Lima) | 30/03/2026 | 43:50 - 50:56 | [Video](https://tinyurl.com/mryc8k2u) <br> <img src="assets/images/cap2/entrevista-32.png" alt="Luciana" width="100"> |
| **ENT-007** | Clientes Finales / Compradores | Albert Ponduro | 29 | Cañete / Lima | 30/03/2026 | 51:01 - 58:04 | [Video](https://tinyurl.com/msecxcnt) <br> <img src="assets/images/cap2/entrevista-33.png" alt="Albert" width="100"> |
...
- **ENT-002 (Joe Cañamero - Agricultor, Cusco):**
  Joe es un agricultor cusqueño que prioriza la simplicidad en el uso de herramientas digitales. Indicó que para adoptar una aplicación móvil requiere una experiencia guiada y sencilla, ya que las interfaces complejas le generan desconfianza. Asimismo, opera en un entorno rural con frecuentes cortes de energía e intermitencia de red, por lo que valora una aplicación móvil que permita consultar información previamente almacenada sin conexión continua y actualizarla cuando se recupere la conectividad.

- **ENT-003 (Anita Monago Cachay - Compradora Mayorista, Lima):**
...
- **ENT-007 (Albert Ponduro - Cliente Final / Comprador Mayorista, Cañete):**
  Albert (29 años) es comprador mayorista y comerciante en el Mercado Modelo. Destaca que la falta de verificación sobre el origen y manejo del suelo le genera incertidumbre al negociar. Cree indispensable una interfaz móvil ágil con escaneo QR o un dashboard simplificado que le permita mostrar a sus clientes información registrada sobre el origen y las condiciones de cultivo de los productos.

### 2.2.3. Análisis de entrevistas

El análisis de las entrevistas consolida las variables objetivas (demográficas) y subjetivas (comportamiento, tecnología y dolores) para fundamentar los requisitos de la solución móvil **TerraTech**.
...
| **Proveedores de Insumos** | Rango de edad | 26 años | 1 | 1 | 100% | ENT-004 |
| **Proveedores de Insumos** | Nivel educativo | Superior técnica | 1 | 1 | 100% | ENT-004 |
| **Proveedores de Insumos** | Canal de comunicación principal | WhatsApp / Teléfono móvil | 1 | 1 | 100% | ENT-004 |
| **Proveedores de Insumos** | Principal dolor | Falta de datos de campo para respaldar recomendaciones | 1 | 1 | 100% | ENT-004 |
| **Proveedores de Insumos** | Dispositivo de preferencia | Smartphone de gama media | 1 | 1 | 100% | ENT-004 |
| **Proveedores de Insumos** | Interés en app móvil de monitoreo | Alto (diagnóstico de lotes y respaldo técnico) | 1 | 1 | 100% | ENT-004 |
| **Clientes Finales / Compradores** | Rango de edad | 17 a 35 años | 4 | 4 | 100% | ENT-003, ENT-005, ENT-006, ENT-007 |
| **Clientes Finales / Compradores** | Nivel educativo | Secundaria completa / Superior en curso o completa | 4 | 4 | 100% | ENT-003, ENT-005, ENT-006, ENT-007 |
| **Clientes Finales / Compradores** | Uso de smartphone para compras/búsqueda | Diario (Redes sociales, mensajería, escaneo QR) | 4 | 4 | 100% | ENT-003, ENT-005, ENT-006, ENT-007 |
| **Clientes Finales / Compradores** | Factor decisivo de compra | Frescura, calidad y verificación de procedencia | 4 | 4 | 100% | ENT-003, ENT-005, ENT-006, ENT-007 |
| **Clientes Finales / Compradores** | Mecanismo preferido de trazabilidad | Código QR escaneable desde la cámara del móvil | 4 | 4 | 100% | ENT-003, ENT-005, ENT-006, ENT-007 |
...
- **Segmento 2 (Proveedores de Insumos Agrícolas):**
  Este segmento cuenta con asesoría técnica y alta adopción tecnológica móvil (uso activo de smartphones y mensajería instantánea). Su principal cuello de botella es la falta de datos objetivos del suelo al momento de prescribir insumos a los agricultores. Una aplicación móvil con paneles de consulta de lotes de clientes y sugerencias automáticas de dosificación le permitirá ahorrar tiempo y respaldar técnicamente sus recomendaciones de insumos.

- **Segmento 3 (Clientes Finales y Compradores Mayoristas):**
  Los compradores y consumidores representan a un público digital y consciente de la calidad y sostenibilidad. El 100% utiliza su smartphone de forma cotidiana y valora positivamente la verificación de la procedencia de los alimentos mediante la lectura de códigos QR o fichas informativas en puntos de venta o negociación mayorista. Esto valida el interés en que la aplicación móvil TerraTech permita generar fichas informativas de trazabilidad compartibles mediante enlace digital o escaneo de código QR, facilitando a clientes y compradores la consulta de la información registrada por el agricultor sobre sus cultivos.
...
Las fichas de User Persona presentan el perfil de cada segmento objetivo y reúnen sus datos demográficos, metas, frustraciones, habilidades tecnológicas, marcas e influencias y canales de interacción. Cada ficha se elaboró en UXPressia a partir de las entrevistas ENT-001 a ENT-007: el agricultor (ENT-001, ENT-002) presenta baja alfabetización digital y conectividad limitada; el proveedor de insumos (ENT-004) necesita datos objetivos del suelo para respaldar sus recomendaciones; y los clientes finales y compradores mayoristas (ENT-003, ENT-005, ENT-006, ENT-007) priorizan la transparencia y la trazabilidad del producto. Asimismo, cada ficha incorpora las características más frecuentes del análisis estadístico presentado en 2.2.3 y las oportunidades de diferenciación detectadas en 2.1.
